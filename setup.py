...
lambda_name = 'stepfunctions-start-execution-task'
...
lambda_description = 'Starts a step-function execution'
...
lambda_author='Gabriel Wortmann'
lambda_author_email='wortmanngabriel@gmail.com'
